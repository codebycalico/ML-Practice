# needs Internet connection for assemblyai
# ollama uses local computer essentially
...
class AIVoiceAgent:
    ...
    # Automatically stop when detecting silent periods
    ...
    def _play_speech(self, text: str):
        ...
        audio_url = "N/A"
        try:
            # Can add feature to assess the sentiment and reflect that with the tonality / emotion in response
            resp = replicate.run(
    ...
    def _generate_response(self, transcript):
        ...
        try:
            # Essentially loading ollama onto your computer and running locally
            # use the 1b model, the small version, so that it's as fast as possible locally
